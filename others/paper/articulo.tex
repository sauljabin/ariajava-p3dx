...
al entorno. Se segmentó el mapa con la Triangulación de Delaunay para generar dicho diagrama.
Por otra parte, se explica el funcionamiento e instalación de la aplicación de software 
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=6cm]{ventana-principal-conexion.png} 
\caption{Ventana principal conexión.}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=6cm]{mapa-cargado.png} 
...
\pagebreak
\subsubsection*{\textit{Menu Opciones}}
...
\pagebreak
\subsubsection*{\textit{Menu Ayuda}}
